...
import "../../../../public/css/fixed-title-ribbon.css";
...
export default class FixedNavbar extends Component {
    ...
    render() {
        return (
            <div id="title-section" className="title-section stucked">
                <div id="title-ribbon" className="title-ribbon stucked">
            ...
            L284.286,256.002z"
                    ...
                    <svg
                        ...
                        id="contact-btn"
                        className={
                            "expander " + this.props.contactBtn == "hide"
                                ? "hidden"
                                : ""
                        }
                        xmlns="http://www.w3.org/2000/svg"
...
c0,205.845,167.488,373.333,373.333,373.333c17.643,0,32-14.357,32-32V298.88C405.333,281.237,390.976,266.88,373.333,266.88z"
    ...
    gotoContacts() {
        console.log("gotoContacts Clicked");
    }
}
