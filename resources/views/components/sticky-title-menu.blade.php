...
<div id="title-section" class="sticky-top title-section">
    ...
    <div id="main-container">
        ...
        <div id="title-ribbon" class="title-ribbon">
            ...
            <svg onclick="togglemenu(true)" id="menu-expander" class="expander" viewBox="0 0 515.555 515.555">
            ...
            <svg onclick="showContacts()" version="1.1" id="contact-btn" class="expander" viewBox="0 0 515.555 515.555">
                <path
