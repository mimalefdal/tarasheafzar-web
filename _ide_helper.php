 ...
 * Generated for Laravel 7.0.4 on 2020-07-09 08:15:40.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Route {
        ...
        {
                        return \Illuminate\Routing\Router::adminRoutes();
        }
         ...
         * @static 
         */ 
        public static function staffRoutes()
        {
                        return \Illuminate\Routing\Router::staffRoutes();
        }
         ...
         * @static 
         */ 
        public static function reactAppVersionRoutes()
        {
                        return \Illuminate\Routing\Router::reactAppVersionRoutes();
        }
